...
function errorHandling() {
  axios.post('https://jsonplaceholder.typicode.com/todosss',{title:'New Todo',completed:'false'})
  .then(res=> showOutput(res))
  .catch(err => {
    if(err.respose){
...
axios.interceptors.request.use(
  config=>{console.log(`${config.method.toUpperCase()} sends request to ${config.url}
